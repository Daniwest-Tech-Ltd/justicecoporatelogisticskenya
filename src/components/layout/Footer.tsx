          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
            ...
            <div className="space-y-4">
              ...
              <p className="text-muted-foreground text-sm leading-relaxed">
                ...
                NTSA compliant fleet with fully insured vehicles.
              </p>
              ...
              <ul className="space-y-4">
                <li className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <a href="tel:0702575512" className="font-medium hover:text-primary transition-colors">
                      0702575512
                    </a>
                  </div>
                </li>
                <li className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <a href="mailto:rentals@justicelogisticskenya.com" className="font-medium hover:text-primary transition-colors text-sm">
